...
## About
A lightweight OCR-based overlay for Droid Tycoon with real-time HUD detection, audio cues, and seamless Windows 10 & 11 auto-updates.

## Installation
1. Download `DroidTycoonHelper_Setup.exe` using the link above.
2. Run the installer and follow the prompt.
3. Launch Droid Tycoon Helper from your desktop or Start menu.
